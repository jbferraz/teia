  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body>
        <div class="form-group">
            <div>
                <form class="col-sm-4">
                <label id="star1" onmouseover="mudaestar(1)" class="glyphicon glyphicon-star-empty" style="font-size:50px"></label>
                <input id="res1" type="hidden" >
                <label id="star2" onmouseover="mudaestar(2)" class="glyphicon glyphicon-star-empty" style="font-size:50px"></label>
